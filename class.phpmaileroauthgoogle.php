...
class GmailXOAuth2 {
    ...
    public static $oauthCClientId = '';
    public static $oauthCClientSecret = '';
    ...
    public function __construct(
        ...
        // $this->oauthAccessToken = $AcccessToken;


        GmailXOAuth2::$oauthAccessToken=$AcccessToken;
        GmailXOAuth2::$oauthCClientId=$ClientId;
        GmailXOAuth2::$oauthCClientSecret=$ClientSecret;

        // $client = GmailXOAuth2::getClient($ClientId,$ClientSecret);
        // $client->setAccessToken($AcccessToken);
    }
    ...
    public static function getClient($clientId='',$clientSecret='') {
        ...
        $google_client->setClientId(GmailXOAuth2::$oauthCClientId);
        $google_client->setClientSecret(GmailXOAuth2::$oauthCClientSecret);
    ...
    public function getOauth64 () {
        ...
        // echo GmailXOAuth2::$oauthAccessToken;die;
        $client->setAccessToken(GmailXOAuth2::$oauthAccessToken);
